...
import { downloadMediaMessage } from "anita-baileys";
import te from "../../src/lib/anita-error.js";
import anitaApi from "../../src/lib/anita-apimanager.js";
...
async function handler(m, { sock }) {
  ...
  try {
    ...
    const data = await anitaApi.neoxr.whatMusic(
      {
        url: audioUrl,
        apikey: config.APIkey?.neoxr || "Milik-Bot-AnitaMD",
      },
      {
        timeout: 60000,
      },

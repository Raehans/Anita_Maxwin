...
import { generateWAMessageFromContent, prepareWAMessageMedia, proto } from "anita-baileys";
...
import { getCasesByCategory, getCaseCount } from "../../case/anita.js";
const pluginConfig = {
  name: "allmenu",
...
function getContextInfo(botConfig, m, thumbBuffer) {
  const saluranId = botConfig.saluran?.id || "120363409623385879@newsletter";
  const saluranName =
  ...
  try {
    switch (allmenuVariant) {
      ...
      case 5: {
        ...
        const thumbnail = await _sharp(fs.readFileSync(config.assets["anita-baileys"])).resize(300, 300).toBuffer()
        const qOrder = {
        ...
        const media4 = await prepareWAMessageMedia({ video: fs.readFileSync(config.assets["anita-mp4"]), gifPlayback: true }, { upload: sock.waUploadToServer });
            ...
            message: {
              ...
              interactiveMessage: {
                ...
                contextInfo: {
                  ...
                  forwardingScore: 9,
                  forwardedNewsletterMessageInfo: {
                    newsletterJid: config.saluran?.id || "120363409623385879@newsletter",
                    newsletterName: config.saluran?.name || config.bot?.name || "Ryo-ai",
                    serverMessageId: 127,
                  },
                },
              ...
              message: {
                orderMessage: {
                  ...
                  contextInfo: {
                    ...
                    forwardingScore: 9,
                    forwardedNewsletterMessageInfo: {
                      newsletterJid: "120363409623385879@newsletter",
                      newsletterName: "Anita Bot",
                      serverMessageId: 127,
                    },
                  },
                },

...
import { getCasesByCategory } from "../../case/anita.js";
import { prepareWAMessageMedia, generateWAMessageFromContent } from "anita-baileys";
...
import { getTimeGreeting } from "../../src/lib/anita-formatter.js";
import fs from "fs"
      ...
      switch (menucatVariant) {
        ...
        case 2: {
          const media = await prepareWAMessageMedia(
            {
              image: fs.readFileSync(config.assets["anita2"]),
            },

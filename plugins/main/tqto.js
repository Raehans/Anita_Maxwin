...
import fs from 'fs'
import { AIRich } from '../../src/lib/anita-builder.js'
const pluginConfig = {
    name: 'tqto',
...
async function handler(m, { sock }) {
    ...
    const credits = [
        ...
        { name: 'Zann', role: 'Creator Ryo Yamada MD dan APK Stardem Anita', icon: '👨‍💻' },
        { name: 'SenzOkkotsu', role: 'Developer', icon: '👨‍💻' },
        { name: 'Ell', role: 'Developer', icon: '👨‍💻' },
        { name: 'Aqell', role: 'Developer SC BUG Anita Glitch', icon: '👨‍💻' },

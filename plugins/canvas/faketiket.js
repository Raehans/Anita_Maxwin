...
const pluginConfig = {
    ...
    example: '.faketiket Jakarta | Tokyo | Ryo Yamada',
    isOwner: false,
    isPremium: false,
    isGroup: false,
    isPrivate: false,
...
async function handler(m, { sock }) {
    ...
    if (!text) {
        return m.reply(
            ...
            `┃ ✦ *Contoh*\n` +
            `┃\n` +
            `┃   ${m.prefix}faketiket Jakarta | Tokyo | Ryo Yamada\n` +
            `┃\n` +
            `┃ 💗 *Ryo Yamada:* Mau kemana darling~?\n` +
            `╰━━━━━━━━━━━━━━━━━━━━━⬣`
        )
    }
    ...
    m.react('💕')
    await m.reply(`⏳ *ᴘʀᴏᴄᴇꜱꜱɪɴɢ...*\n\n💗 *Ryo Yamada:* Lagi bikin tiket pesawat darling~`)
    ...
    try {
        ...
        await sock.sendMessage(m.chat, {
            ...
            caption: `💕 *ғᴀᴋᴇ ᴛɪᴋᴇᴛ* 💕\n\n` +
                    ...
                    `┃ 👤 *ɴᴀᴍᴀ*: ${nama}\n` +
                    `┃\n` +
                    `┃ 💗 *Ryo Yamada:* Ini tiketnya darling~ selamat jalan-jalan! 🗿\n` +
                    `╰━━━━━━━━━━━━━━━━━━━━━⬣`
        }, { quoted: m })

...
const pluginConfig = {
    ...
    example: '.fakesertifikat Ryo Yamada | Best Darling Award',
    isOwner: false,
    isPremium: false,
    isGroup: false,
    isPrivate: false,
...
async function handler(m, { sock }) {
    ...
    if (!text) {
        return m.reply(
            ...
            `┃ ✦ *Contoh*\n` +
            `┃\n` +
            `┃   ${m.prefix}fakesertifikat Ryo Yamada | Best Darling Award\n` +
            `┃\n` +
            `┃ 💗 *Ryo Yamada:* Mau award apa darling~?\n` +
            `╰━━━━━━━━━━━━━━━━━━━━━⬣`
        )
    }
    ...
    m.react('💕')
    await m.reply(`⏳ *ᴘʀᴏᴄᴇꜱꜱɪɴɢ...*\n\n💗 *Ryo Yamada:* Lagi bikin sertifikat darling~`)

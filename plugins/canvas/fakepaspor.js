...
const pluginConfig = {
    ...
    example: '.fakepaspor Ryo Yamada | 20 | Jepang',
    isOwner: false,
    isPremium: false,
    isGroup: false,
    isPrivate: false,
...
async function handler(m, { sock }) {
    ...
    if (!text) {
        return m.reply(
            ...
            `┃ ✦ *Contoh*\n` +
            `┃\n` +
            `┃   ${m.prefix}fakepaspor Ryo Yamada | 20 | Jepang\n` +
            ...
            `┃\n` +
            `┃ 💗 *Ryo Yamada:* Mau bikin paspor palsu siapa darling~?\n` +
            `╰━━━━━━━━━━━━━━━━━━━━━⬣`
        )
    }
    ...
    m.react('💕')
    await m.reply(`⏳ *ᴘʀᴏᴄᴇꜱꜱɪɴɢ...*\n\n💗 *Ryo Yamada:* Lagi bikin fake paspor darling~ tunggu sebentar yaa 🎨`)
    ...
    try {
        ...
        await sock.sendMessage(m.chat, {
            ...
            caption: `💕 *ғᴀᴋᴇ ᴘᴀꜱᴘᴏʀ* 💕\n\n` +
                    ...
                    `┃\n` +
                    `┃ ⚠️ *Cuma buat konten!*\n` +
                    `┃ 💗 *Ryo Yamada:* Ini paspornya darling~ jangan dipake beneran ya! 🗿\n` +
                    `╰━━━━━━━━━━━━━━━━━━━━━⬣`
        }, { quoted: m })

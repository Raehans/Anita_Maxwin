import {
  ...
  isLidConverted,
  lidToJid,
} from "../../src/lib/anita-lid.js";
import moment from "moment-timezone";
import config from "../../config.js";
import { getDatabase } from "../../src/lib/anita-database.js";
import { saluranCtx } from "../../src/lib/anita-context.js";
import { createGoodbyeCard } from "../../src/lib/anita-welcome-card.js";
import { resolveAnyLidToJid } from "../../src/lib/anita-lid.js";
import path from "path";
import fs from "fs";
import te from "../../src/lib/anita-error.js";
import { getAssetBuffer } from "../../src/lib/anita-asset-manager.js";
...
function resolvePlaceholders(
  ...
  return template
    ...
    .replace(/{bot}/gi, config.bot?.name || "Anita")
...
async function sendGoodbyeMessage(sock, groupJid, participant, groupMeta) {
  try {
    ...
    if (goodbyeType === 2) {
      ...
      await sock.sendMessage(groupJid, {
        video: getAssetBuffer("anita-mp4") || { url: "https://files.catbox.moe/k28dhp.mp4" },
        gifPlayback: true,
        caption: text,
        contextInfo: {
          mentionedJid: [realParticipant],

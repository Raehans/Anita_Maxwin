...
const pluginConfig = {
  ...
  category: "group",
  description: "Utilitas admin grup tambahan yang tidak tersedia di Ryo Yamada.",
  usage: ".<command>",
  example: ".admincount",
  isGroup: true,
  isAdmin: true,
  ...
  try{
    ...
    switch(c){
      ...
      case "quicklock":{
        ...
        return m.reply("🔒 Quick Lock aktif: grup dikunci dan proteksi dasar Ryo Yamada diaktifkan.");
      }
      case "quickunlock":{
        const gd=db?.getGroup?.(m.chat)||{};

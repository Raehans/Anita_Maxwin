...
try {
  ...
  if (fs.existsSync(path.join(assetsPath, "anita-games.jpg"))) {
    thumbWW = fs.readFileSync(path.join(assetsPath, "anita-games.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "anita.jpg"))) {
    thumbNight = fs.readFileSync(path.join(assetsPath, "anita.jpg"));
    thumbDay = fs.readFileSync(path.join(assetsPath, "anita.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "anita-winner.jpg"))) {
    thumbWin = fs.readFileSync(path.join(assetsPath, "anita-winner.jpg"));
  }
} catch (e) {

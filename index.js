...
import { loadPlugins, pluginStore } from "./src/lib/anita-plugins.js";
import { initDatabase, getDatabase } from "./src/lib/anita-database.js";
import {
  initScheduler,
  loadScheduledMessages,
  startGroupScheduleChecker,
  startSewaChecker,
} from "./src/lib/anita-scheduler.js";
import { handleAntiTagSW } from "./src/lib/anita-group-protection.js";
import { initSholatScheduler } from "./src/lib/anita-sholat-scheduler.js";
import { initNotifScheduler } from "./src/lib/anita-notif-scheduler.js";
import { initAutoJpmScheduler } from "./src/lib/anita-auto-jpm.js";
import { startMemoryMonitor } from "./src/lib/anita-memory-monitor.js";
import { startTempCleaner } from "./src/lib/anita-temp-cleaner.js";
import { startDailyPruner } from "./src/lib/anita-data-pruner.js";
import { preloadAssets } from "./src/lib/anita-asset-manager.js";
import {
  logger,
  c,
  playBootSequence,
  ...
  logErrorBox,
  divider,
} from "./src/lib/anita-logger.js";
import {
  restoreSessionFromEnv,
  printSessionPersistenceInfo,
} from "./src/lib/anita-session-persistence.js";
import {
  startKeepAlive,
  updateConnectionStatus,
} from "./src/lib/anita-keepalive.js";

await import("./src/lib/anita-agent.js")
    ...
    (eventType, filename) => {
      ...
      const timeout = setTimeout(async () => {
        ...
        if (!fs.existsSync(fullPath)) {
          ...
          const { unloadPlugin } = await import("./src/lib/anita-plugins.js");
        ...
        try {
          ...
          const { hotReloadPlugin } =
            await import("./src/lib/anita-plugins.js");
...
async function main() {
  // ── Deepnote: print info session persistence ─────────────────────────────
  printSessionPersistenceInfo();

  // ── Deepnote: restore session WA dari env var (jika ada) ─────────────────
  await restoreSessionFromEnv();

  // ── Deepnote: jalankan HTTP keep-alive server ─────────────────────────────
  startKeepAlive(config.bot?.name || "Ryo Yamada MD");
      ...
      if (update.connection === "open") {
        ...
        try {
          const { startOtpPoller: _startOtp } =
            await import("./src/lib/anita-otp-poller.js");
          _startOtp(sock);
        } catch { }

        try {
          const { getAllJadibotSessions, restartJadibotSession } =
            await import("./src/lib/anita-jadibot-manager.js");

import {
  ...
  getRandomReward,
  getProgressiveHint,
} from "./anita-game-data.js";
import { getDatabase } from "./anita-database.js";
import { addExpWithLevelCheck } from "./anita-level.js";
import {
  getGameContextInfo,
  sendGamePreview,
  checkFastAnswer,
} from "./anita-context.js";
import config from "../../config.js";
import fs from "fs";
import sharp from "sharp";
let fetchBuffer;
try {
  fetchBuffer = (await import("./anita-utils.js")).fetchBuffer;
} catch { }
...
const games = new AnitaGames();

export { AnitaGames, games };

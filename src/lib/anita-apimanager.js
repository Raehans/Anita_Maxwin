...
/**
 * @typedef {Object} AnitaApiAuthShape
 * @property {Object<string, any>} [headers]
 * @property {Object<string, any>} [params]
 */

/**
 * @typedef {Object} AnitaApiProviderShape
 * @property {string} baseURL
 * @property {AnitaApiAuthShape} [auth]
...
/**
 * @typedef {Object} AnitaApiRequestOptions
...
/**
 * @typedef {Object} AnitaApiMultipartFile
 ...
 */
class AnitaApiProvider {
  /**
   * @param {AnitaApiManager} mgr
   * @param {string} name
   */
  ...
  /**
   * @param {string} ep
   * @param {AnitaApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
  request(ep, opt = {}) {
   ...
   * @param {AnitaApiMultipartFile[]|Object<string, any>} [files]
   * @param {AnitaApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
...
class CovenantApiProvider extends AnitaApiProvider {
  gpt4(input, opt = {}) {
...
class NeoxrApiProvider extends AnitaApiProvider {
  whatMusic(input, opt = {}) {
...
class CukiApiProvider extends AnitaApiProvider {
...
class ApiFaaProvider extends AnitaApiProvider {
...
class AnitaMainApiProvider extends AnitaApiProvider {
  ytmp4(input, opt = {}) {
...
class NexrayApiProvider extends AnitaApiProvider {
  geminiTts(input, opt = {}) {
...
class YupraApiProvider extends AnitaApiProvider {
  brat(input, opt = {}) {
    return this.get("/api/image/brat", this.asParams(input, "text"), opt);
  }
}

class EmiliabotApiProvider extends AnitaApiProvider {
...
class AzbryApiProvider extends AnitaApiProvider {
...
class YuulabsApiProvider extends AnitaApiProvider {
  tiktok(input, opt = {}) {
    return this.get("/api/downloader/tiktok", this.asParams(input, "url"), opt);
  }
}

class ZenzxzApiProvider extends AnitaApiProvider {
  youtube(input, opt = {}) {
...
class FgsiApiProvider extends AnitaApiProvider {
...
/**
 * API manager terpusat untuk provider eksternal Anita.
 */
class AnitaApiManager {
  /**
  ...
  /**
   * @param {string} name
   * @param {AnitaApiProviderShape} cfg
   * @returns {AnitaApiProvider}
   */
  ...
  /**
   * @param {string} name
   * @param {Partial<AnitaApiProviderShape>} cfg
   * @returns {AnitaApiProvider}
   */
  ...
  makeProviderClient(name) {
    const ProviderClass = this.providerClasses?.[name] || AnitaApiProvider;
...
const anitaApi = new AnitaApiManager();

export { AnitaApiManager, AnitaApiProvider, anitaApi };
export default anitaApi;

...
import * as ownerPremiumDb from "./src/lib/anita-premium-db.js";

//  utamakan baca object config sampai bawah
const config = {
  info: {
    website: "https://youtube.com/@brianzrimex?si=pIRZQd1siJGNZbHA",
    grupwa: "",
  },

  owner: {
    name: "Anita Maxwin", // Nama owner
    number: ["6285764575407"], // Format: 628xxx (tanpa + atau 0)
  },

  session: {
    pairingNumber: "6285764575407", // Nomor WA yang akan di-pair, ini penting
  ...
  bot: {
    name: "Ryo Yamada MD", // Nama bot
    version: "3.3", // Versi bot
    developer: "Anita Putri Azzahra", // Nama developer
  },

  assets: {
    "anita-daftar": "./assets/image/anita-daftar.png",
    "anita-demote": "./assets/image/anita-demote.png",
    "anita-fishit": "./assets/image/anita-fishit.jpg",
    "anita-games": "./assets/image/anita-games.jpg",
    "anita-landscape": "./assets/image/anita-landscape.jpg",
    "anita-levelup": "./assets/image/anita-levelup.jpg",
    "anita-minecraft": "./assets/image/anita-minecraft.jpg",
    "anita-promote": "./assets/image/anita-promote.png",
    "anita-rpg": "./assets/image/anita-rpg.jpg",
    "anita-rules": "./assets/image/anita-rules.jpg",
    "anita-store": "./assets/image/anita-store.png",
    "anita-v8": "./assets/image/anita-v8.jpg",
    "anita-winner": "./assets/image/anita-winner.jpg",
    "anita-baileys": "./assets/image/anita.png",
    "anita2": "./assets/image/anita2.jpg",
    "anita3": "./assets/image/anita3.jpg",
    "pp-kosong": "./assets/image/pp-kosong.jpg",
    "anita-mp4": "./assets/video/anita-mp4.mp4",
    "anita-mp3": "./assets/audio/anita-mp3.mp3",
    "anita-font": "./assets/anita-font.ttf",
    "anita-kertas": "./assets/image/anita-kertas.jpg",
  },
  ...
  payment: {
    qrisUrl: "",
    methods: [
      { name: "Dana", number: "08xxxxxxxx", holder: "Anita Putri Azzahra" },
      { name: "GoPay", number: "08xxxxxxxx", holder: "Anita Putri Azzahra" },
      { name: "OVO", number: "08xxxxxxxx", holder: "Anita Putri Azzahra" },
      { name: "ShopeePay", number: "08xxxxxxxx", holder: "Anita Putri Azzahra" },
    ],
    banks: [],
  ...
  sticker: {
    packname: "Ryo Yamada MD", // Nama pack sticker
    author: "Anita Putri Azzahra", // Author sticker
  },

  saluran: {
    id: "120363409623385879@newsletter", // ID saluran (contoh: 120363xxx@newsletter)                          // ID saluran (contoh: 120363xxx@newsletter)
    name: "FebxyZ YT</>", // Nama saluran
    link: "https://whatsapp.com/channel/0029Vb8pJjxB4hdRpWZeJg0Z", // Link saluran
  },
